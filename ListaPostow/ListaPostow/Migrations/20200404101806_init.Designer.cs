...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ListaPostow.Models.Db.ChanelUsers", b =>
                {
                    ...
                    b.ToTable("ChanelUsers");
                });

            modelBuilder.Entity("ListaPostow.Models.Db.Post", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ListaPostow.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ListaPostow.Models.Db.ChanelUsers", b =>
                {
                    b.HasOne("ListaPostow.Models.Db.Chanel", "Chanel")
                        .WithMany("ChanelUsers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ListaPostow.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
