    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChanelUsers", x => x.ID);
                    table.ForeignKey(
                        name: "FK_ChanelUsers_Chanels_ChanelID",
                        column: x => x.ChanelID,
                        principalTable: "Chanels",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChanelUsers_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_Chanels_ChanelID",
                        column: x => x.ChanelID,
                        principalTable: "Chanels",
                        principalColumn: "ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChanelUsers_UserID",
                table: "ChanelUsers",
                column: "UserID");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_ChanelID",
                table: "Posts",
                column: "ChanelID");
